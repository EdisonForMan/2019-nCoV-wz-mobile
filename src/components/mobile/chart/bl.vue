  ...
  methods: {
    ...
    NYJJMap() {
      ...
      this.chart.setOption({
        ...
        //   show: false,
        //   min: 0,
        //   max: this.mapdata_bl.sort((a, b) => b.value - a.value)[0].value,
        //   inRange: {
        //     color: [
        //       "#ffffff",
        //       "#feeeef",
            ...
            markPoint: {
              ...
              label: {
                normal: {
                  ...
                  formatter: ["{title|{b}}", "病例小区{num1|{c}}"].join("\n"),
                  rich: {
                    title: {
                      color: "black",
                      fontSize: 12,
